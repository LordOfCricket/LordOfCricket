...
export default function ReputationBadges({ verified, badges = [], size = 'md' }) {
  ...
  return (
    <div className="flex flex-wrap items-center gap-1.5">
      {verified && (
        <span className={`inline-flex items-center gap-1 rounded-full border border-emerald-400/30 bg-emerald-500/10 ${padding} ${textSize} font-semibold text-emerald-300`}>
      ...
      {badges.map((key) => {
        ...
        return (
          <span
            ...
            className={`inline-flex items-center gap-1 rounded-full border border-amber-400/25 bg-amber-500/10 ${padding} ${textSize} font-semibold text-amber-200`}
          >
