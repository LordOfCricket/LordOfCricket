    ...
    <div className="flex w-full flex-wrap justify-center gap-8 px-6 lg:gap-10 lg:px-10">
      {partners.map((partner) => {
        ...
        return (
          ...
          >
            <div className="flex h-24 w-24 items-center justify-center overflow-hidden rounded-2xl border border-emerald-400/15 bg-white/5 shadow-lg shadow-black/30 transition-all duration-300 hover:-translate-y-1 hover:scale-105 hover:border-emerald-400/50 hover:shadow-emerald-500/20 sm:h-28 sm:w-28">
              <img
